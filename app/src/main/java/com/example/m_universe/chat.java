...
public class chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check user status, get user data, and read messages
        checkUserStatus();
        ...
        userquery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    String nameh = "" + dataSnapshot1.child("uname").getValue();
                    ...
                    name.setText(nameh);
                    try {
                        Glide.with(chat.this).load(image).placeholder(R.drawable.ic_profile2).into(profile);
                    } catch (Exception e) {
    ...
    protected void onPause() {
        super.onPause();
        // Update online status and typing status when the activity is paused
    ...
    protected void onResume() {
        // Set online status to "online" when the activity is resumed
    ...
    public boolean onSupportNavigateUp() {
        // Handle navigating up (e.g., back button in the toolbar)
        onBackPressed();
        return super.onSupportNavigateUp();
    }

    // Check and update online status in the database
    ...
    // Check and update typing status in the database
    ...
    protected void onStart() {
        // Check user status and set online status to "online" on start
        checkUserStatus();
        checkOnlineStatus("online");
        super.onStart();
    }

    // Read messages from the database and update the UI
    ...
    // Show a dialog to pick an image from the camera or gallery
    ...
    // Handle the result of the image capture or selection
    @Override
    ...
    // Send an image message by uploading the image to Firebase Storage
